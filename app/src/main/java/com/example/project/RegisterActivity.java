...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText InputName, InputPhoneNumber, InputPassword, InputCPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputCPassword=(EditText)findViewById(R.id.register_cpassword_input);
    ...
    private void CreateAccount() {
        ...
        if (TextUtils.isEmpty(name)){
            ...
            Toast.makeText(this,"Both Password are not Match...", Toast.LENGTH_SHORT).show();
        }
